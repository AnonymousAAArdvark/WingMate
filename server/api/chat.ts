...
export default async function handler(
  ...
  try {
    ...
    const systemPrompt = [
      ...
      formatProfile("Assistant profile (your facts)", body.userProfile),
      formatProfile("Other profile (their facts)", body.counterpartProfile),
      "MEMORY & CONSISTENCY:",
      "- ALWAYS stay consistent with 'Assistant profile (your facts)'.",
